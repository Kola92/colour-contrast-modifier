...
const changeBgColor = (r, g, b) => {
  container.style.backgroundColor = `rgb(${r}, ${g}, ${b})`;
}

// Creations of object for neural network
const createNetworkObject = (r,g, b) => {
...
const networkLabel = (result) => {
  result.light > result.dark ? result = 'light' : result = 'dark';
...
for(var i = 0; i < sliderInput.length; i++){
	sliderInput[i].addEventListener("input", function(){
		...
		changeBgColor(redSlider,greenSlider,blueSlider);
